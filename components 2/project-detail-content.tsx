...
<a href={`/api/cors/pdf?projectId=${project.id}`} target="_blank" rel="noopener noreferrer" title="Print Log (PDF)"
              className="px-3 py-2 text-sm border border-border rounded-lg hover:bg-muted flex items-center gap-1.5">
...
<a href={`/api/rfis/pdf?projectId=${project.id}`} target="_blank" rel="noopener noreferrer" title="Print Log (PDF)"
              className="px-3 py-2 text-sm border border-border rounded-lg hover:bg-muted flex items-center gap-1.5">
              <Printer className="w-4 h-4" /> Print Log
            </a>
...
<a href={`/api/submittals/pdf?projectId=${project.id}`} target="_blank" rel="noopener noreferrer" title="Print Log (PDF)"
              className="px-3 py-2 text-sm border border-border rounded-lg hover:bg-muted flex items-center gap-1.5">
              <Printer className="w-4 h-4" /> Print Log
            </a>
