...
const NAV_BY_ROLE: Record<string, string[]> = {
  full: [
    ...
    '/dashboard/buyout', '/dashboard/pay-apps', '/dashboard/lien-waivers', '/dashboard/punch-list', '/dashboard/closeout', '/dashboard/budgets', '/dashboard/photos',
  ...
  superintendent: [
    ...
    '/dashboard/analytics', '/dashboard/settings', '/dashboard/help', '/dashboard/punch-list', '/dashboard/closeout',
